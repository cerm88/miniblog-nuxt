...
article.post {
  ...
  .markdown {
    ...
    pre {
      @apply w-full block bg-gray-200 font-mono my-4 px-4 py-4
      box-border overflow-x-auto;
    }
    code {
  ...
  .to-top {
    @apply pointer-events-none absolute sticky w-full flex
    justify-end my-4 px-4 py-4 left-0 right-0 bottom-0;
    button {
